...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        BGTaskScheduler.shared.register(forTaskWithIdentifier: "com.rove.app.healthGPT.refresh", using: nil) { task in
    ...
    func scheduleAppRefreshIfNeeded() {
        ...
        if !viewModel.hasOpenedToday {
            ...
            let request = BGAppRefreshTaskRequest(identifier: "com.rove.app.healthGPT.refresh")
